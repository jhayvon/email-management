...
<body>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="approve_track.php" class="nav-item">
                                <span class="mx-3"><i class="fa-solid fa-calendar"></i> Approval Record</span>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="row justify-content-center">
                    <table id="example" class="table">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM `request` WHERE status= 'Pending' ORDER BY id DESC";
                            ...
                            <tr>
                              ...
                              <!--   <td>
                                ...
                                <!-- Action -->
                                <td>
                                   <button value="<?= $row['id'] ?>" class="viewAll button btnView fa-solid fa-eye" type="button"
                                        data-bs-toggle="modal" data-bs-target="#viewAllModal"></button>


                                    <button value="<?= $row['id'] ?>" class="button btnReply fa-solid fa-pen" type="button"
                                        data-bs-toggle="modal" data-bs-target="#replyModal"></button>

                                        
                                    <button value="<?= $row['id'] ?>" class="approve button btnapprove fa-solid fa-check"></button>

                                    <button value="<?= $row['id'] ?>" class="delete button btndel fa-solid fa-trash"></button>
    ...
    <!-- Modal -->
    <div class="modal fade modal-xl" id="replyModal" style="overflow: wrap;" tabindex="-1" aria-labelledby="replyModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="reply_create" class="" style="word-wrap: break-word;">
                        ...
                        <p style="margin-left: 40px;"><b>Username:<input type="text" name="email" value="fname.lname@deped.gov.ph"><span class="reply_email"></span></b></p>
                        <input type="hidden" name="pword" value="fname.lname">
                        <p style="margin-left: 40px;"><b>Password: <?php echo "asdasd1234"?><span class="reply_password"></span></b></p>
                        <p><b>References:</b></p>
                        ...
                        <textarea name="toEmail" style="width:100%; height:500px;">
                            Please click the link below for your feedback:</b></p>
                        <p>https://l.facebook.com/l.php?u=https%3A%2F%2Fforms.gle%2FF3PKV3tp4WQEaet16%3Ffbclid%3DIwAR1KBXO5ay-2w3fEp30u5SHovd6-j-GZNvKKEVkpUKskEXoSKPC2z9a7aYQ&h=AT3dctitvUghRBr_mkQZ5n8wnUKunCiEe05LSMSJnfXhCzCf4Le4LnJJXNy8U4PZarUhfuj3AIE9I-4m-xme4PjtL-UwXqCmUOvYrlBAMtQxvPKRx99puBrW9aOQihyS8aV330v24V53luk
                        </textarea>
                    </div>
...
$(document).ready(function() {
    ...
    //     $.ajax({
    //         type: "POST",
    //         url: "../controller/delete_request.php",
    //         data: {
    //             "id", id,
    //         },
